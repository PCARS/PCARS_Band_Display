...
#define BUFFER_SIZE 16  // Buffer used to store CI-V packets
...
extern String tx_rx_1;   // Store current tx/rx mode for radio # 1
extern String tx_rx_2;   // Store current tx/rx mode for radio # 2
